...
var Translate = function(_a11) {
  var i18nKey = _a11.i18nKey, options = _a11.options, children = _a11.children;
...
var useCreatePath = function() {
  ...
  return (0, import_react29.useCallback)(function(_a11) {
...
var useLogout = function() {
  ...
  var logout = (0, import_react34.useCallback)(function(params, redirectTo, redirectToCurrentLocationAfterLogin) {
    if (params === void 0) {
      params = {};
    }
...
var useAuthState = function(params, logoutOnFailure, queryOptions2) {
  ...
  var queryResult = useQuery(__assign2({ queryKey: ["auth", "checkAuth", params], queryFn: function(_a11) {
    var signal = _a11.signal;
    if (!authProvider) {
      return true;
    }
    return authProvider.checkAuth(__assign2(__assign2({}, params), { signal })).then(function() {
      return true;
  ...
  var result = (0, import_react35.useMemo)(function() {
    return __assign2(__assign2({}, queryResult), { authenticated: queryResult.error ? false : queryResult.data });
  }, [queryResult]);
...
var useLogoutIfAccessDenied = function() {
  ...
  var notify = useNotify();
  var navigate = useNavigate();
  var logoutIfAccessDenied = (0, import_react36.useCallback)(function(error) {
    if (!authProvider) {
...
var usePermissions = function(params, queryParams) {
  ...
  var queryResult = useQuery(__assign3({ queryKey: ["auth", "getPermissions", params], queryFn: function(_a12) {
      ...
      return __generator2(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4, authProvider.getPermissions(__assign3(__assign3({}, params), { signal }))];
          case 1:
            permissions = _b.sent();
  ...
  var result = (0, import_react37.useMemo)(function() {
    return __assign3(__assign3({}, queryResult), { permissions: queryResult.data });
  }, [queryResult]);
...
var useFilterState_default = function(_a11) {
  ...
  var _e = (0, import_react41.useState)(__assign5(__assign5({}, permanentFilter), filterToQuery(""))), filter = _e[0], setFilterValue = _e[1];
  ...
  (0, import_react41.useEffect)(function() {
    if (!(0, import_isEqual.default)(permanentFilterProp.current, permanentFilter)) {
      ...
      setFilterValue(__assign5(__assign5({}, permanentFilter), filterToQuery(latestValue.current || "")));
    }
  ...
  var setFilter = (0, import_react41.useCallback)((0, import_debounce2.default)(function(value) {
    setFilterValue(__assign5(__assign5({}, permanentFilter), filterToQuery(value)));
...
var removeEmpty = function(object) {
  return Object.keys(object).reduce(function(acc, key) {
    ...
    return isEmpty(child) ? acc : __assign6(__assign6({}, acc), (_a11 = {}, _a11[key] = child, _a11));
  }, {});
};
  ...
  switch (action.type) {
    case SET_SORT:
      if (action.payload.field === previousState.sort) {
        return __assign7(__assign7({}, previousState), { order: (_b = action.payload.order) !== null && _b !== void 0 ? _b : oppositeOrder(previousState.order), page: 1 });
      }
      return __assign7(__assign7({}, previousState), { sort: action.payload.field, order: action.payload.order || SORT_ASC, page: 1 });
    case SET_PAGE:
      return __assign7(__assign7({}, previousState), { page: action.payload });
    case SET_PER_PAGE:
      return __assign7(__assign7({}, previousState), { page: 1, perPage: action.payload });
    case SET_FILTER: {
      return __assign7(__assign7({}, previousState), { page: 1, filter: action.payload.filter, displayedFilters: action.payload.displayedFilters ? action.payload.displayedFilters : previousState.displayedFilters });
    }
    case SHOW_FILTER: {
      if (previousState.displayedFilters && previousState.displayedFilters[action.payload.filterName]) {
        return previousState;
      }
      return __assign7(__assign7({}, previousState), {
        ...
        displayedFilters: __assign7(__assign7({}, previousState.displayedFilters), (_a11 = {}, _a11[action.payload.filterName] = true, _a11))
      });
    }
    case HIDE_FILTER: {
      return __assign7(__assign7({}, previousState), {
        ...
        displayedFilters: previousState.displayedFilters ? Object.keys(previousState.displayedFilters).reduce(function(filters, filter) {
          var _a12;
          return filter !== action.payload ? __assign7(__assign7({}, filters), (_a12 = {}, _a12[filter] = true, _a12)) : filters;
...
var useSortState = function(initialSort) {
  ...
  var _a11 = (0, import_react42.useReducer)(sortReducer, initialSort), sort = _a11[0], dispatch = _a11[1];
...
var paginationReducer = function(prevState, nextState) {
  return __assign8(__assign8({}, prevState), nextState);
};
...
var usePaginationState_default = function(initialPagination) {
  ...
  var _a11 = (0, import_react43.useReducer)(paginationReducer, __assign8(__assign8({}, defaultPagination), initialPagination)), pagination = _a11[0], setPagination = _a11[1];
...
var fetchJson = function(url, options) {
  ...
  return fetch(url, __assign9(__assign9({}, options), { headers: requestHeaders })).then(function(response) {
...
var testDataProvider = function(overrides) {
  return __assign10(__assign10({}, defaultTestDataProvider), overrides);
};
...
var withLifecycleCallbacks = function(dataProvider, handlers) {
  return __assign11(__assign11({}, dataProvider), { getList: function(resource, params) {
...
var useLoading = function() {
  ...
  var _a11 = import_react47.default.useState(isFetchingRef.current || isMutatingRef.current), isLoading = _a11[0], setIsLoading = _a11[1];
...
var useGetOne = function(resource, _a11, options) {
  ...
  var result = useQuery(__assign12({
...
var useGetList = function(resource, params, options) {
  ...
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign13({ queryKey: [resource, "getList", { pagination, sort, filter, meta }], queryFn: function(queryParams) {
  ...
  var metaValue = (0, import_react50.useRef)(meta);
  var resourceValue = (0, import_react50.useRef)(resource);
  ...
  return (0, import_react50.useMemo)(function() {
    return result.data ? __assign13(__assign13({}, result), result.data) : result;
  }, [result]);
};
var noop6 = function() {
  return void 0;
...
var useGetMany = function(resource, params, options) {
  ...
  var metaValue = (0, import_react51.useRef)(meta);
  var resourceValue = (0, import_react51.useRef)(resource);
...
var useGetManyAggregate = function(resource, params, options) {
  ...
  var onSettledEvent = useEvent(onSettled);
  var ids = params.ids, meta = params.meta;
  var placeholderData = (0, import_react52.useMemo)(function() {
  ...
  var metaValue = (0, import_react52.useRef)(meta);
  var resourceValue = (0, import_react52.useRef)(resource);
...
var useGetManyReference = function(resource, params, options) {
  ...
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useQuery(__assign16({ queryKey: [
    resource,
    "getManyReference",
  ...
  return (0, import_react53.useMemo)(function() {
    return result.data ? __assign16(__assign16({}, result), result.data) : result;
  }, [result]);
};
var noop9 = function() {
  return void 0;
...
var AddUndoableMutationContext = (0, import_react54.createContext)(function() {
});

// node_modules/ra-core/dist/esm/dataProvider/undo/TakeUndoableMutationContext.js
var import_react55 = __toESM(require_react());
var TakeUndoableMutationContext = (0, import_react55.createContext)(function() {
});
...
var UndoableMutationsContextProvider = function(_a11) {
  var children = _a11.children;
  var _b = (0, import_react56.useState)([]), mutations = _b[0], setMutations = _b[1];
  var addMutation = (0, import_react56.useCallback)(function(mutation) {
    setMutations(function(mutations2) {
      return __spreadArray8(__spreadArray8([], mutations2, true), [mutation], false);
    });
  }, []);
  var takeMutation = (0, import_react56.useCallback)(function() {
...
var useAddUndoableMutation = function() {
  return (0, import_react57.useContext)(AddUndoableMutationContext);
};

// node_modules/ra-core/dist/esm/dataProvider/undo/useTakeUndoableMutation.js
var import_react58 = __toESM(require_react());
var useTakeUndoableMutation = function() {
  return (0, import_react58.useContext)(TakeUndoableMutationContext);
};
...
var useCreate = function(resource, params, options) {
  ...
  var _a11 = options.mutationMode, mutationMode = _a11 === void 0 ? "pessimistic" : _a11, getMutateWithMiddlewares = options.getMutateWithMiddlewares, mutationOptions = __rest11(options, ["mutationMode", "getMutateWithMiddlewares"]);
  var mode = (0, import_react59.useRef)(mutationMode);
  var paramsRef = (0, import_react59.useRef)(params);
  var snapshot = (0, import_react59.useRef)([]);
  var mutateWithMiddlewares = (0, import_react59.useRef)(dataProvider.create);
  var callTimeOnError = (0, import_react59.useRef)();
  var callTimeOnSettled = (0, import_react59.useRef)();
  var hasCallTimeOnSuccess = (0, import_react59.useRef)(false);
  var updateCache = function(_a12) {
    var resource2 = _a12.resource, id = _a12.id, data2 = _a12.data, meta2 = _a12.meta;
    var now = Date.now();
  ...
  var mutation = useMutation(__assign17(__assign17({ mutationFn: function(_a12) {
    var _b = _a12 === void 0 ? {} : _a12, _c = _b.resource, callTimeResource = _c === void 0 ? resource : _c, _d = _b.data, callTimeData = _d === void 0 ? paramsRef.current.data : _d, _e = _b.meta, callTimeMeta = _e === void 0 ? paramsRef.current.meta : _e;
    if (!callTimeResource) {
    ...
    if (mode.current === "pessimistic") {
      var _a12 = variables.resource, callTimeResource = _a12 === void 0 ? resource : _a12;
      queryClient.setQueryData([callTimeResource, "getOne", { id: String(data2.id) }], data2);
      queryClient.invalidateQueries({
      ...
      return __generator5(this, function(_d) {
        switch (_d.label) {
          ...
          case 1:
            ...
            setTimeout(function() {
              if (onSuccess) {
                onSuccess(callTimeData, __assign17({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess && !hasCallTimeOnSuccess.current) {
                mutationOptions.onSuccess(callTimeData, __assign17({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
  ...
  var mutationResult = (0, import_react59.useMemo)(function() {
...
var useUpdate = function(resource, params, options) {
  ...
  var mode = (0, import_react60.useRef)(mutationMode);
  var paramsRef = (0, import_react60.useRef)(params);
  var snapshot = (0, import_react60.useRef)([]);
  var mutateWithMiddlewares = (0, import_react60.useRef)(dataProvider.update);
  var callTimeOnError = (0, import_react60.useRef)();
  var callTimeOnSettled = (0, import_react60.useRef)();
  var hasCallTimeOnSuccess = (0, import_react60.useRef)(false);
  var updateCache = function(_a12) {
      ...
      return __generator6(this, function(_e) {
        switch (_e.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign18({ resource: callTimeResource }, callTimeParams), __assign18({ onSuccess }, otherCallTimeOptions))];
              }
              return [2, mutation.mutate(__assign18({ resource: callTimeResource }, callTimeParams), __assign18({ onSuccess }, otherCallTimeOptions))];
            }
          ...
          case 1:
            ...
            setTimeout(function() {
              if (onSuccess) {
                onSuccess(__assign18(__assign18({}, previousRecord), callTimeData), __assign18({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess && !hasCallTimeOnSuccess.current) {
                mutationOptions.onSuccess(__assign18(__assign18({}, previousRecord), callTimeData), __assign18({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
  ...
  var mutationResult = (0, import_react60.useMemo)(function() {
...
var useUpdateMany = function(resource, params, options) {
  ...
  var mode = (0, import_react61.useRef)(mutationMode);
  var paramsRef = (0, import_react61.useRef)(params);
  var snapshot = (0, import_react61.useRef)([]);
  var hasCallTimeOnError = (0, import_react61.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react61.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react61.useRef)(false);
  var updateCache = function(_a12) {
    ...
    return __awaiter7(void 0, void 0, void 0, function() {
      ...
      return __generator7(this, function(_b) {
        ...
        updateColl = function(old) {
          ...
          ids2.forEach(function(id) {
            ...
            newCollection = __spreadArray10(__spreadArray10(__spreadArray10([], newCollection.slice(0, index), true), [
              __assign19(__assign19({}, newCollection[index]), clonedData)
        ...
        ids2.forEach(function(id) {
          queryClient.setQueryData([resource2, "getOne", { id: String(id), meta: meta2 }], function(record) {
            return __assign19(__assign19({}, record), clonedData);
          }, { updatedAt });
        });
        queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
          return res && res.data ? __assign19(__assign19({}, res), { data: updateColl(res.data) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
          return res && res.pages ? __assign19(__assign19({}, res), { pages: res.pages.map(function(page) {
            return __assign19(__assign19({}, page), { data: updateColl(page.data) });
          }) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
          return coll && coll.length > 0 ? updateColl(coll) : coll;
      ...
      return __generator7(this, function(_e) {
        switch (_e.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign19({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions)];
              }
          ...
          case 2:
            ...
            setTimeout(function() {
              if (otherCallTimeOptions.onSuccess) {
                otherCallTimeOptions.onSuccess(callTimeIds, __assign19({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess) {
                mutationOptions.onSuccess(callTimeIds, __assign19({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
  ...
  var mutationResult = (0, import_react61.useMemo)(function() {
...
var useDelete = function(resource, params, options) {
  ...
  var mode = (0, import_react62.useRef)(mutationMode);
  var paramsRef = (0, import_react62.useRef)(params);
  var snapshot = (0, import_react62.useRef)([]);
  var hasCallTimeOnError = (0, import_react62.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react62.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react62.useRef)(false);
  var updateCache = function(_a12) {
    ...
    var updateColl = function(old) {
      ...
      return __spreadArray11(__spreadArray11([], old.slice(0, index), true), old.slice(index + 1), true);
    };
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
      if (!res || !res.data)
        return res;
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      ...
      return __assign20(__assign20({}, res), { pages: res.pages.map(function(page) {
        ...
        return recordWasFound ? __assign20(__assign20({}, page), { data: newCollection, total: page.total ? page.total - 1 : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
      ...
      return __generator8(this, function(_c) {
        switch (_c.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              return [2, mutation.mutate(__assign20({ resource: callTimeResource }, callTimeParams), otherCallTimeOptions)];
            }
            return [4, Promise.all(snapshot.current.map(function(_a13) {
              var queryKey = _a13[0];
              return queryClient.cancelQueries({ queryKey });
          ...
          case 1:
            ...
            setTimeout(function() {
              if (callTimeOptions.onSuccess) {
                callTimeOptions.onSuccess(callTimePreviousData, __assign20({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess) {
                mutationOptions.onSuccess(callTimePreviousData, __assign20({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
  ...
  var mutationResult = (0, import_react62.useMemo)(function() {
...
var useDeleteMany = function(resource, params, options) {
  ...
  var mode = (0, import_react63.useRef)(mutationMode);
  var paramsRef = (0, import_react63.useRef)({});
  var snapshot = (0, import_react63.useRef)([]);
  var hasCallTimeOnError = (0, import_react63.useRef)(false);
  var hasCallTimeOnSuccess = (0, import_react63.useRef)(false);
  var hasCallTimeOnSettled = (0, import_react63.useRef)(false);
  var updateCache = function(_a12) {
    ...
    var updateColl = function(old) {
      if (!old)
        return old;
      var newCollection = __spreadArray12([], old, true);
      ids2.forEach(function(id) {
        ...
        newCollection = __spreadArray12(__spreadArray12([], newCollection.slice(0, index), true), newCollection.slice(index + 1), true);
      });
      return newCollection;
    };
    queryClient.setQueriesData({ queryKey: [resource2, "getList"] }, function(res) {
    ...
    queryClient.setQueriesData({ queryKey: [resource2, "getInfiniteList"] }, function(res) {
      if (!res || !res.pages)
        return res;
      return __assign21(__assign21({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign21(__assign21({}, page), { data: newCollection, total: page.total ? page.total - (page.data.length - newCollection.length) : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData({ queryKey: [resource2, "getMany"] }, function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  var mutation = useMutation(__assign21(__assign21({ mutationFn: function(_a12) {
    ...
    return __awaiter9(void 0, void 0, void 0, function() {
      ...
      return __generator9(this, function(_a12) {
        switch (_a12.label) {
          ...
          case 1:
            userContext = _a12.sent() || {};
            return [2, __assign21({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
      ...
      return __generator9(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              return [2, mutation.mutate(__assign21({ resource: callTimeResource }, callTimeParams), {
          ...
          case 1:
            ...
            setTimeout(function() {
              if (otherCallTimeOptions.onSuccess) {
                otherCallTimeOptions.onSuccess(callTimeIds, __assign21({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              } else if (mutationOptions.onSuccess) {
                mutationOptions.onSuccess(callTimeIds, __assign21({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }
            }, 0);
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign21({ resource: callTimeResource }, callTimeParams), {
              ...
              addUndoableMutation(function(_a13) {
                ...
                if (isUndo) {
                  ...
                  mutation.mutate(__assign21({ resource: callTimeResource }, callTimeParams), {
                    onSettled: otherCallTimeOptions.onSettled,
                    onError: otherCallTimeOptions.onError
                  });
                }
  ...
  var mutationResult = (0, import_react63.useMemo)(function() {
    return __assign21({ isLoading: mutation.isPending }, mutation);
  }, [mutation]);
  return [useEvent(mutate), mutationResult];
};
...
var useInfiniteGetList = function(resource, params, options) {
  ...
  var onErrorEvent = useEvent(onError);
  var onSettledEvent = useEvent(onSettled);
  var result = useInfiniteQuery(__assign22(__assign22({ queryKey: [
    resource,
    "getInfiniteList",
  ...
  return result.data ? __assign22(__assign22({}, result), { data: result.data, total: (_c = (_b = (_a11 = result.data) === null || _a11 === void 0 ? void 0 : _a11.pages[0]) === null || _b === void 0 ? void 0 : _b.total) !== null && _c !== void 0 ? _c : void 0, meta: (_e = (_d = result.data) === null || _d === void 0 ? void 0 : _d.pages[0]) === null || _e === void 0 ? void 0 : _e.meta }) : result;
};
var noop10 = function() {
  return void 0;
};
...
var useDeleteWithUndoController = function(props) {
  ...
  var handleDelete = (0, import_react65.useCallback)(function(event) {
    ...
    deleteOne(resource, {
      ...
      previousData: record,
      meta: mutationMeta
    }, __assign23({ mutationMode: "undoable" }, otherMutationOptions));
...
var useDeleteWithConfirmController = function(props) {
  ...
  var handleDelete = (0, import_react66.useCallback)(function(event) {
    event.stopPropagation();
    if (!record) {
      throw new Error("The record cannot be deleted because no record has been passed");
    }
    deleteOne(resource, {
      ...
      previousData: record,
      meta: mutationMeta
    }, __assign24({ mutationMode }, otherMutationOptions));
    if (typeof onClick === "function") {
      onClick(event);
    }
  }, [
...
var SaveContext = (0, import_react67.createContext)({});
...
var usePickSaveContext = function(context) {
  var value = (0, import_react68.useMemo)(
    function() {
...
var useSaveContext = function(_props) {
  return (0, import_react69.useContext)(SaveContext);
};
...
var useMutationMiddlewares = function() {
  var callbacks = (0, import_react70.useRef)([]);
  var registerMutationMiddleware = (0, import_react70.useCallback)(function(callback) {
    callbacks.current.push(callback);
  }, []);
  var unregisterMutationMiddleware = (0, import_react70.useCallback)(function(callback) {
    callbacks.current = callbacks.current.filter(function(cb) {
      return cb !== callback;
    });
  }, []);
  var getMutateWithMiddlewares = (0, import_react70.useCallback)(function(fn) {
  ...
  var functions = (0, import_react70.useMemo)(function() {
    return {
      registerMutationMiddleware,
...
var useCreateController = function(props) {
  ...
  var disableAuthentication = props.disableAuthentication, record = props.record, redirectTo = props.redirect, transform2 = props.transform, _a11 = props.mutationMode, mutationMode = _a11 === void 0 ? "pessimistic" : _a11, _b = props.mutationOptions, mutationOptions = _b === void 0 ? {} : _b;
  var resource = useResourceContext(props);
  if (!resource) {
  ...
  var _e = useCreate(resource, void 0, __assign25(__assign25({ onSuccess: function(data, variables, context) {
...
var CreateContext = (0, import_react73.createContext)(null);
...
var CreateContextProvider = function(_a11) {
  ...
  return React26.createElement(
    ...
    React26.createElement(
      SaveContextProvider,
      { value: __assign26(__assign26({}, usePickSaveContext(value)), { mutationMode: "pessimistic" }) },
...
var CreateBase = function(_a11) {
  ...
  return (
    ...
    React27.createElement(
      ...
      React27.createElement(CreateContextProvider, { value: controllerProps }, children)
    )
  );
};
...
var useCreateContext = function() {
  var context = (0, import_react74.useContext)(CreateContext);
  if (!context) {
...
var useEditController = function(props) {
  ...
  var _g = useGetOne(resource, { id, meta: queryMeta }, __assign27({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, onError: function() {
  ...
  var _h = useUpdate(resource, recordCached, __assign27(__assign27({ onSuccess: function(data, variables, context) {
  ...
  var save = (0, import_react75.useCallback)(function(data, _a12) {
    var _b2 = _a12 === void 0 ? {} : _a12, onSuccessFromSave = _b2.onSuccess, onErrorFromSave = _b2.onError, transformFromSave = _b2.transform, metaFromSave = _b2.meta;
    return Promise.resolve(transformFromSave ? transformFromSave(data, {
      ...
      return __awaiter11(void 0, void 0, void 0, function() {
        var error_1;
        var _a13;
        return __generator11(this, function(_b3) {
          switch (_b3.label) {
            case 0:
              _b3.trys.push([0, 2, , 3]);
...
var WithRecord = function(_a11) {
  ...
  return record ? React28.createElement(React28.Fragment, null, render(record)) : null;
};
...
var EditContext = (0, import_react76.createContext)(null);
...
var EditBase = function(_a11) {
  ...
  return (
    ...
    React32.createElement(
      OptionalResourceContextProvider,
      { value: props.resource },
      React32.createElement(EditContextProvider, { value: controllerProps }, children)
    )
  );
};
...
var useEditContext = function() {
  var context = (0, import_react77.useContext)(EditContext);
  if (!context) {
...
var ReferenceFieldContext = (0, import_react78.createContext)(null);
var ReferenceFieldContextProvider = ReferenceFieldContext.Provider;
var useReferenceFieldContext = function() {
  var context = (0, import_react78.useContext)(ReferenceFieldContext);
  if (!context) {
...
var useReferenceFieldController = function(options) {
  ...
  var referenceRecordQuery = useReference({
    reference,
    id,
    options: __assign28(__assign28({}, queryOptions2), { enabled: ((queryOptions2 === null || queryOptions2 === void 0 ? void 0 : queryOptions2.enabled) == null || (queryOptions2 === null || queryOptions2 === void 0 ? void 0 : queryOptions2.enabled) === true) && id != null })
  });
  ...
  var result = (0, import_react79.useMemo)(function() {
    return __assign28(__assign28({}, referenceRecordQuery), { link: path });
...
var ReferenceFieldBase = function(props) {
  ...
  return React33.createElement(
    ...
    React33.createElement(
      ...
      React33.createElement(RecordContextProvider, { value: controllerProps.referenceRecord }, children)
    )
  );
};
...
var ExporterContext = (0, import_react80.createContext)(defaultExporter);
...
var useRecordSelection = function(args) {
  ...
  var _c = (0, import_react81.useState)(defaultSelection), localIds = _c[0], setLocalIds = _c[1];
  ...
  var reset = (0, import_react81.useCallback)(function() {
  ...
  var selectionModifiers = (0, import_react81.useMemo)(function() {
    return {
...
function useSafeSetState(initialState2) {
  var _a11 = (0, import_react82.useState)(initialState2), state = _a11[0], setState = _a11[1];
  var mountedRef = (0, import_react82.useRef)(false);
  ...
  var safeSetState = (0, import_react82.useCallback)(function(args) {
    if (mountedRef.current) {
...
function usePrevious(value) {
  var ref = (0, import_react82.useRef)();
  (0, import_react82.useEffect)(function() {
    ref.current = value;
  });
  return ref.current;
...
function useDeepCompareEffect(callback, inputs) {
  var cleanupRef = (0, import_react82.useRef)();
  (0, import_react82.useEffect)(function() {
...
function useTimeout(ms, key) {
  ...
  var _a11 = (0, import_react82.useState)(false), ready = _a11[0], setReady = _a11[1];
  (0, import_react82.useEffect)(function() {
    setReady(false);
...
function useIsMounted() {
  var isMounted = (0, import_react82.useRef)(true);
  (0, import_react82.useEffect)(function() {
...
var useListParams = function(_a11) {
  ...
  var location = useLocation();
  var navigate = useNavigate();
  var _g = (0, import_react83.useState)(defaultParams), localParams = _g[0], setLocalParams = _g[1];
    ...
    if (!tempParams.current) {
      ...
      setTimeout(function() {
        ...
        if (disableSyncWithLocation && !storeKey) {
          ...
          navigate({
            search: "?".concat((0, import_query_string2.stringify)(__assign29(__assign29({}, tempParams.current), { filter: JSON.stringify(tempParams.current.filter), displayedFilters: JSON.stringify(tempParams.current.displayedFilters) })))
          }, {
            state: {
  ...
  var setPage = (0, import_react83.useCallback)(function(newPage) {
    return changeParams({ type: SET_PAGE, payload: newPage });
  }, [changeParams]);
  var setPerPage = (0, import_react83.useCallback)(function(newPerPage) {
  ...
  return [
    __assign29(__assign29({ filterValues, requestSignature }, query), { displayedFilters: displayedFilterValues }),
    {
      changeParams,
      setPage,
      setPerPage,
...
var getQuery = function(_a11) {
  ...
  var query = Object.keys(queryFromLocation).length > 0 ? queryFromLocation : hasCustomParams(params) ? __assign29({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
  ...
  return __assign29(__assign29({}, query), { page: getNumberOrDefault(query.page, 1), perPage: getNumberOrDefault(query.perPage, 10) });
};
...
var useSelectAll = function(params) {
  ...
  var handleSelectAll = useEvent(function(_a12) {
    ...
    return __awaiter12(void 0, void 0, void 0, function() {
      ...
      var _e;
      return __generator12(this, function(_f) {
        switch (_f.label) {
          case 0:
          ...
          case 1:
            _f.trys.push([1, 3, , 4]);
            return [4, queryClient.fetchQuery(__assign30({ queryKey: [
              resource,
              "getList",
              {
...
var useInfiniteListController = function(props) {
  ...
  if (filter && (0, import_react84.isValidElement)(filter)) {
  ...
  var unwrappedData = (0, import_react84.useMemo)(function() {
    var _a12;
...
var ListSortContext = (0, import_react87.createContext)(void 0);
...
var ListPaginationContext = (0, import_react88.createContext)(void 0);
  ...
  return React34.createElement(
    ...
    React34.createElement(
      ...
      React34.createElement(
        ...
        React34.createElement(ListPaginationContext.Provider, { value: usePickPaginationContext(value) }, children)
      )
    )
  );
};
...
var InfinitePaginationContext = (0, import_react89.createContext)({
  hasNextPage: false,
  ...
  return (
    ...
    React35.createElement(
      ...
      React35.createElement(
        ListContextProvider,
        { value: controllerProps },
        React35.createElement(InfinitePaginationContext.Provider, { value: {
...
var useListController = function(props) {
  ...
  if (filter && ((0, import_react90.isValidElement)(filter) || Array.isArray(filter) && filter.some(import_react90.isValidElement))) {
  ...
  var _k = useGetList(resource, {
    ...
    sort: { field: query.sort, order: query.order },
    filter: __assign32(__assign32({}, query.filter), filter),
    meta
  }, __assign32({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, placeholderData: function(previousData) {
    return previousData;
  }, retry: false, onError: function(error2) {
    return notify((error2 === null || error2 === void 0 ? void 0 : error2.message) || "ra.notification.http_error", {
      type: "error",
  ...
  var currentSort = (0, import_react90.useMemo)(function() {
    return {
      field: query.sort,
      order: query.order
    };
...
var getListControllerProps = function(props) {
  return injectedProps.reduce(function(acc, key) {
    var _a11;
    return __assign32(__assign32({}, acc), (_a11 = {}, _a11[key] = props[key], _a11));
  }, {});
};
...
var ListBase = function(_a11) {
  ...
  return (
    ...
    React36.createElement(
      OptionalResourceContextProvider,
      { value: props.resource },
      React36.createElement(ListContextProvider, { value: controllerProps }, children)
    )
  );
};
...
var useExpanded = function(resource, id, single) {
  ...
  var toggleExpanded = (0, import_react91.useCallback)(function() {
...
var useExpandAll = function(resource, ids) {
  ...
  var toggleExpandedAll = (0, import_react91.useCallback)(function() {
...
var useInfinitePaginationContext = function() {
  return (0, import_react92.useContext)(InfinitePaginationContext);
};
...
var useList = function(props) {
  ...
  var resource = useResourceContext(props);
  var _j = (0, import_react93.useState)(isFetching), fetchingState = _j[0], setFetchingState = _j[1];
  var _k = (0, import_react93.useState)(isLoading), loadingState = _k[0], setLoadingState = _k[1];
  var _l = (0, import_react93.useState)(isPending), pendingState = _l[0], setPendingState = _l[1];
  var _m = (0, import_react93.useState)(function() {
    return {
      data,
  ...
  var setSort = (0, import_react93.useCallback)(function(sort2) {
    setSortState(sort2);
    setPage(1);
  ...
  var filterRef = (0, import_react93.useRef)(filter);
  var _r = (0, import_react93.useState)({}), displayedFilters = _r[0], setDisplayedFilters = _r[1];
  var _s = (0, import_react93.useState)(filter), filterValues = _s[0], setFilterValues = _s[1];
  ...
  var showFilter = (0, import_react93.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a12;
      return __assign33(__assign33({}, previousState), (_a12 = {}, _a12[filterName] = true, _a12));
    });
    setFilterValues(function(previousState) {
      var _a12;
      return removeEmpty_default(__assign33(__assign33({}, previousState), (_a12 = {}, _a12[filterName] = defaultValue, _a12)));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var setFilters = (0, import_react93.useCallback)(function(filters, displayedFilters2) {
  ...
  var onSelectAll = (0, import_react93.useCallback)(function() {
...
var useListContext = function() {
  var context = (0, import_react94.useContext)(ListContext);
  if (!context) {
...
var useListContextWithProps = function(props) {
  var context = (0, import_react95.useContext)(ListContext);
...
var useListFilterContext = function() {
  var context = (0, import_react96.useContext)(ListFilterContext);
  if (!context) {
...
var useListPaginationContext = function() {
  var context = (0, import_react97.useContext)(ListPaginationContext);
  if (!context) {
...
var useListSortContext = function() {
  var context = (0, import_react98.useContext)(ListSortContext);
  if (!context) {
...
var useUnselect = function(resource) {
  ...
  return (0, import_react99.useCallback)(function(ids) {
    unselect(ids);
  }, [unselect]);
};
...
var useUnselectAll = function(resource) {
  ...
  return (0, import_react100.useCallback)(function() {
    clearSelection();
  }, [clearSelection]);
};
...
var useReferenceArrayFieldController = function(props) {
  ...
  var _e = useGetManyAggregate(reference, { ids, meta }, __assign34({ onError: function(error2) {
  ...
  return __assign34(__assign34({}, listProps), { defaultTitle: void 0, refetch: refetch2, resource: reference });
};
...
var useReferenceManyFieldController = function(props) {
  ...
  var setSort = (0, import_react101.useCallback)(function(sort2) {
    setSortState(sort2);
    setPage(1);
  }, [setPage, setSortState]);
  var _j = useRecordSelection({
  ...
  var filterRef = (0, import_react101.useRef)(filter);
  var _k = (0, import_react101.useState)({}), displayedFilters = _k[0], setDisplayedFilters = _k[1];
  var _l = (0, import_react101.useState)(filter), filterValues = _l[0], setFilterValues = _l[1];
  var hideFilter = (0, import_react101.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
  ...
  var showFilter = (0, import_react101.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a12;
      return __assign35(__assign35({}, previousState), (_a12 = {}, _a12[filterName] = true, _a12));
    });
    setFilterValues(function(previousState) {
      var _a12;
      return __assign35(__assign35({}, previousState), (_a12 = {}, _a12[filterName] = defaultValue, _a12));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var debouncedSetFilters = (0, import_react101.useCallback)((0, import_debounce4.default)(function(filters, displayedFilters2) {
    setFilterValues(removeEmpty_default(filters));
    setDisplayedFilters(displayedFilters2);
    setPage(1);
  }, debounce5), [setDisplayedFilters, setFilterValues, setPage]);
  var setFilters = (0, import_react101.useCallback)(function(filters, displayedFilters2, debounce6) {
    if (debounce6 === void 0) {
      debounce6 = false;
    }
    if (debounce6) {
  ...
  var _m = useGetManyReference(reference, {
    ...
    filter: filterValues,
    meta
  }, __assign35({ enabled: (0, import_get6.default)(record, source) != null, placeholderData: function(previousData) {
    return previousData;
  ...
  var onSelectAll = useEvent(function(_a12) {
    ...
    return __awaiter13(void 0, void 0, void 0, function() {
      ...
      var _e2;
      return __generator13(this, function(_f2) {
        switch (_f2.label) {
          case 0:
...
var useReferenceParams = function(_a11) {
  ...
  var _f = (0, import_react102.useState)(defaultParams2), params = _f[0], setParams = _f[1];
  var tempParams = (0, import_react102.useRef)();
  var requestSignature = [
    resource,
  ...
  var query = (0, import_react102.useMemo)(
    function() {
      return getQuery2({
        params,
  ...
  var changeParams = (0, import_react102.useCallback)(function(action) {
    if (!tempParams.current) {
  ...
  var setSort = (0, import_react102.useCallback)(
    function(sort2) {
      return changeParams({
        type: SET_SORT,
        payload: sort2
  ...
  var setPage = (0, import_react102.useCallback)(
    function(newPage) {
      return changeParams({ type: SET_PAGE, payload: newPage });
    },
    requestSignature
  ...
  var setPerPage = (0, import_react102.useCallback)(
    function(newPerPage) {
      return changeParams({ type: SET_PER_PAGE, payload: newPerPage });
    },
    requestSignature
  ...
  var debouncedSetFilters = (0, import_react102.useRef)((0, import_debounce5.default)(function(filter2, displayedFilters) {
    if (displayedFilters === void 0) {
      displayedFilters = void 0;
    }
    changeParams({
  ...
  var setFilters = (0, import_react102.useCallback)(
  ...
  return [
    __assign37(__assign37({ filterValues, requestSignature }, query), { displayedFilters: displayedFilterValues }),
    {
      changeParams,
      setPage,
      setPerPage,
...
var getQuery2 = function(_a11) {
  ...
  var query = hasCustomParams2(params) ? __assign37({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
    query.sort = sort.field;
    query.order = sort.order;
  }
  ...
  return __assign37(__assign37({}, query), { page: getNumberOrDefault2(query.page, 1), perPage: getNumberOrDefault2(query.perPage, 10) });
};
...
var useReferenceArrayInputController = function(props) {
  ...
  var _h = useGetList(reference, {
    ...
    meta
  }, __assign38({ retry: false, enabled: isGetMatchingEnabled, placeholderData: function(previousData) {
    return previousData;
  ...
  var refetch2 = (0, import_react103.useCallback)(function() {
    refetchGetMany();
    refetchGetMatching();
  }, [refetchGetMany, refetchGetMatching]);
  var currentSort = (0, import_react103.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var useReferenceInputController = function(props) {
  ...
  var _e = useGetList(reference, {
    ...
    sort: { field: params.sort, order: params.order },
    filter: __assign39(__assign39({}, params.filter), filter),
    meta
  }, __assign39({ enabled: isGetMatchingEnabled, placeholderData: function(previousData) {
    return previousData;
  ...
  var _g = useReference({
    ...
    options: __assign39({ enabled: currentValue != null && currentValue !== "", meta }, otherQueryOptions)
  ...
  var _h = (0, import_react104.useState)(void 0), referenceRecord = _h[0], setReferenceRecord = _h[1];
  ...
  var refetch2 = (0, import_react104.useCallback)(function() {
    refetchGetList();
    refetchReference();
  }, [refetchGetList, refetchReference]);
  var currentSort = (0, import_react104.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var ChoicesContext = (0, import_react105.createContext)(void 0);
...
var useChoicesContext = function(options) {
  ...
  var context = (0, import_react106.useContext)(ChoicesContext);
  ...
  var result = (0, import_react106.useMemo)(function() {
...
var useChoices = function(_a11) {
  ...
  var translate = useTranslate();
  var getChoiceText = (0, import_react107.useCallback)(function(choice) {
    if ((0, import_react107.isValidElement)(optionText)) {
    ...
    return (0, import_react107.isValidElement)(choiceName) ? choiceName : translateChoice ? translate(String(choiceName), { _: choiceName }) : String(choiceName);
  }, [optionText, translate, translateChoice]);
  var getChoiceValue = (0, import_react107.useCallback)(function(choice) {
    return (0, import_get8.default)(choice, optionValue);
  }, [optionValue]);
  var getDisableValue = (0, import_react107.useCallback)(function(choice) {
...
var FormGroupsContext = (0, import_react108.createContext)(void 0);
...
var FormGroupsProvider = function(_a11) {
  var children = _a11.children;
  var formGroups = (0, import_react109.useRef)({});
  var subscribers = (0, import_react109.useRef)({});
  var formContextValue = (0, import_react109.useMemo)(function() {
    return {
      /**
...
var useWarnWhenUnsavedChanges = function(enable, formRootPathname, control) {
  ...
  var _b = (0, import_react110.useState)(false), shouldNotify = _b[0], setShouldNotify = _b[1];
...
var getSimpleValidationResolver = function(validate) {
  return function(data) {
    return __awaiter14(void 0, void 0, void 0, function() {
      ...
      return __generator14(this, function(_a11) {
        switch (_a11.label) {
          case 0:
...
var transformErrorFields = function(error) {
  return Object.keys(error).reduce(function(acc, field) {
    ...
    if (Array.isArray(error[field])) {
      ...
      return __assign40(__assign40({}, acc), (_a11 = {}, _a11[field] = transformedArrayErrors, _a11));
    }
    if (isEmptyObject(error[field])) {
      return acc;
    }
    if (typeof error[field] === "object" && !isRaTranslationObj(error[field])) {
      return __assign40(__assign40({}, acc), (_b = {}, _b[field] = transformErrorFields(error[field]), _b));
    }
    return __assign40(__assign40({}, acc), (_c = {}, _c[field] = addTypeAndMessage(error[field]), _c));
  }, {});
};
...
var useNotifyIsFormInvalid = function(control, enabled) {
  ...
  var submitCountRef = (0, import_react111.useRef)(submitCount);
  var notify = useNotify();
...
var useRecordFromLocation = function(props) {
  ...
  var location = useLocation();
  var _a11 = (0, import_react112.useState)(function() {
    return getRecordFromLocation(location, {
      stateSource,
      searchSource
    });
  }), recordFromLocation = _a11[0], setRecordFromLocation = _a11[1];
  var previousRecordRef = (0, import_react112.useRef)(recordFromLocation);
...
var useAugmentedForm = function(props) {
  ...
  var record = useRecordContext(props);
  var defaultValuesIncludingRecord = (0, import_react113.useMemo)(
    function() {
  ...
  var form = useForm(__assign41({ criteriaMode, values: defaultValuesIncludingRecord, reValidateMode, resolver: finalResolver }, rest));
  var formRef = (0, import_react113.useRef)(form);
  useNotifyIsFormInvalid(form.control, !disableInvalidFormNotification);
  var recordFromLocation = useRecordFromLocation();
  var recordFromLocationApplied = (0, import_react113.useRef)(false);
  ...
  var handleSubmit = (0, import_react113.useCallback)(function(values, event) {
    return __awaiter15(void 0, void 0, void 0, function() {
      var errors, finalValues;
      return __generator15(this, function(_a12) {
        switch (_a12.label) {
          case 0:
  ...
  var formHandleSubmit = (0, import_react113.useCallback)(function(event) {
...
function Form(props) {
  ...
  var dataRouterContext = (0, import_react114.useContext)(DataRouterContext);
  var dataRouterStateContext = (0, import_react114.useContext)(DataRouterStateContext);
...
var useFormValues = function() {
  var getValues2 = useFormContext().getValues;
  return __assign43(__assign43({}, useWatch()), getValues2());
};
...
var FormDataConsumer = function(props) {
  ...
  return React41.createElement(FormDataConsumerView, __assign44({ formData }, props));
};
...
var FormGroupContext = (0, import_react115.createContext)(null);
...
var useFormGroups = function() {
  var context = (0, import_react116.useContext)(FormGroupsContext);
  return context;
};
...
var useFormGroup = function(name) {
  ...
  var formGroups = useFormGroups();
  var _b = (0, import_react118.useState)({
    errors: void 0,
    isDirty: false,
    isTouched: false,
    isValid: true,
...
var useFormGroupContext = function() {
  var context = (0, import_react119.useContext)(FormGroupContext);
  return context;
};
...
var useGetValidationErrorMessage = function() {
  ...
  return function(error) {
    if (error.message != null) {
      ...
      return translate(message2, __assign45({ _: message2 }, args));
    }
...
var useUnique = function(options) {
  ...
  var translate = useTranslate();
  var record = useRecordContext();
  var debouncedGetList = (0, import_react121.useRef)(
  ...
  var validateUnique = (0, import_react121.useCallback)(function(callTimeOptions) {
...
var ValidationError = function(props) {
  ...
  if (errorMessage.message) {
    ...
    return React43.createElement(React43.Fragment, null, translate(message2, __assign46({ _: message2 }, args)));
  }
...
var useInput = function(props) {
  ...
  var defaultId = (0, import_react122.useId)();
  if (!finalName && true) {
  ...
  var _c = useController(__assign47({ name: finalName, defaultValue: (0, import_get12.default)(record, finalSource, defaultValue), rules: {
          ...
          switch (_a12.label) {
            case 0:
              if (!sanitizedValidate)
                return [2, true];
              return [4, sanitizedValidate(value, values, __assign47(__assign47({}, props), { finalSource }))];
            case 1:
              error = _a12.sent();
              if (!error)
                return [2, true];
  ...
  var field = __assign47(__assign47({}, controllerField), { value: format2 ? format2(controllerField.value) : controllerField.value, onBlur, onChange });
  return {
    id: id || defaultId,
    field,
    fieldState,
...
var useSuggestions = function(_a11) {
  ...
  var getSuggestions = (0, import_react123.useCallback)(getSuggestionsFactory({
    allowCreate,
    choices: choices2,
    createText,
...
var defaultMatchSuggestion = function(getChoiceText) {
  return function(filter, suggestion, exact) {
    ...
    var isReactElement = (0, import_react123.isValidElement)(suggestionText);
...
var FilterLiveForm = function(props) {
  ...
  var finalResolver = resolver ? resolver : validate ? getSimpleValidationResolver(validate) : void 0;
  var formContext = useForm(__assign48({ mode: "onChange", defaultValues: filterValues, resolver: finalResolver }, rest));
  ...
  var onSubmit = function(values) {
    ...
    setFilters(__assign48(__assign48({}, filterValues), values));
  };
...
var HTMLForm = function(props) {
  return React44.createElement("form", __assign48({}, props));
};
...
var ReferenceInputBase = function(props) {
  ...
  var controllerProps = useReferenceInputController(__assign49(__assign49({}, props), { sort, filter }));
  return import_react125.default.createElement(
    ResourceContextProvider,
    { value: reference },
    import_react125.default.createElement(ChoicesContextProvider, { value: controllerProps }, children)
  );
};
...
var useShowController = function(props) {
  ...
  var _c = useGetOne(resource, { id, meta }, __assign50({ enabled: !isPendingAuthenticated && !isPendingCanAccess || disableAuthentication, onError: function() {
    notify("ra.notification.item_doesnt_exist", {
      type: "error"
    });
    redirect("list", resource);
...
var ShowContext = (0, import_react126.createContext)(null);
...
var useShowContext = function() {
  var context = (0, import_react127.useContext)(ShowContext);
  if (!context) {
...
var usePrevNextController = function(props) {
  ...
  var filter = __assign51(__assign51({}, storedParams.filter), permanentFilter);
  ...
  var queryData = queryClient.getQueryData([
    resource,
    "getList",
    __assign51(__assign51({}, params), { pagination: {
  ...
  var _l = useQuery(__assign51({ queryKey: [resource, "getList", params], queryFn: function(queryParams) {
    return dataProvider.getList(resource, __assign51(__assign51({}, params), { signal: dataProvider.supportAbortSignal === true ? queryParams.signal : void 0 }));
...
var useCanAccess = function(params) {
  ...
  var queryResult = useQuery(__assign52({ queryKey: ["auth", "canAccess", __assign52(__assign52({}, params), { record, resource })], queryFn: function(_a11) {
    var signal = _a11.signal;
    return __awaiter18(void 0, void 0, void 0, function() {
      return __generator18(this, function(_b) {
        ...
        return [2, authProvider.canAccess(__assign52(__assign52({}, params), { record, resource, signal: authProvider.supportAbortSignal ? signal : void 0 }))];
      });
    });
  }, enabled: authProviderHasCanAccess }, params));
  var result = (0, import_react128.useMemo)(function() {
    return __assign52(__assign52({}, queryResult), { canAccess: queryResult.data });
  }, [queryResult]);
...
var useCanAccessResources = function(params) {
  ...
  var queryResult = useQuery(__assign53({ queryKey: ["auth", "canAccess", resources, action, record], queryFn: function(_a11) {
    var signal = _a11.signal;
        ...
        switch (_b.label) {
          case 0:
            return [4, Promise.all(resources.map(function(resource) {
              return __awaiter19(void 0, void 0, void 0, function() {
                var canAccess;
                return __generator19(this, function(_a12) {
                  switch (_a12.label) {
                    case 0:
                      if (!authProvider || !authProvider.canAccess) {
  ...
  var result = (0, import_react130.useMemo)(function() {
    return __assign53({ canAccess: queryResult.data }, queryResult);
  }, [queryResult]);
  var resultWithoutAuthProvider = (0, import_react130.useMemo)(function() {
    return {
...
var useCanAccessCallback = function(options) {
  ...
  var authProvider = useAuthProvider_default();
  var mutateAsync = useMutation(__assign54({ mutationFn: function(params) {
    return __awaiter20(void 0, void 0, void 0, function() {
      return __generator20(this, function(_a11) {
        if (!authProvider || !authProvider.canAccess) {
          return [2, true];
        }
...
var useCheckAuth = function() {
  ...
  var basename = useBasename();
  var loginUrl = removeDoubleSlashes("".concat(basename, "/").concat(defaultAuthParams.loginUrl));
  var checkAuth = (0, import_react131.useCallback)(function(params, logoutOnFailure, redirectTo) {
    if (params === void 0) {
      params = {};
    }
    if (logoutOnFailure === void 0) {
...
var useGetIdentity = function(options) {
  ...
  var result = useQuery(__assign55({ queryKey: ["auth", "getIdentity"], queryFn: function(_a11) {
    ...
    return __awaiter21(void 0, void 0, void 0, function() {
      return __generator21(this, function(_b) {
  ...
  return (0, import_react132.useMemo)(function() {
  ...
  var proxy = new Proxy(provider, {
    get: function(_, name) {
      ...
      return function() {
        ...
        return __awaiter23(_this, void 0, void 0, function() {
          return __generator23(this, function(_a11) {
            switch (_a11.label) {
              case 0:
                return [4, refreshAuth()];
              case 1:
...
var useGetPathForRecord = function(options) {
  ...
  var createPath = useCreatePath();
  var _a11 = (0, import_react135.useState)(link && typeof link !== "function" && record != null ? createPath({
    resource,
    id: record.id,
    type: link
...
var ResourceDefinitionContext = (0, import_react136.createContext)({
  definitions: {},
  register: function() {
  },
  unregister: function() {
...
var ResourceDefinitionContextProvider = function(_a11) {
  ...
  var _c = (0, import_react136.useState)(defaultDefinitions), definitions = _c[0], setState = _c[1];
  var register = (0, import_react136.useCallback)(function(config) {
    setState(function(prev) {
      var _a12;
      return (0, import_isEqual8.default)(prev[config.name], config) ? prev : __assign57(__assign57({}, prev), (_a12 = {}, _a12[config.name] = config, _a12));
    });
  }, []);
  var unregister = (0, import_react136.useCallback)(function(config) {
    setState(function(prev) {
      var _a12 = prev, _b2 = config.name, _ = _a12[_b2], rest = __rest52(_a12, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return rest;
    });
  }, []);
  var contextValue = (0, import_react136.useMemo)(
    function() {
...
var useResourceDefinitionContext = function() {
  return (0, import_react137.useContext)(ResourceDefinitionContext);
};
...
var useGetPathForRecordCallback = function(options) {
  ...
  return (0, import_react138.useCallback)(function(params) {
    return __awaiter24(void 0, void 0, void 0, function() {
      ...
      var _c, _d;
      return __generator24(this, function(_e) {
        switch (_e.label) {
          case 0:
...
var useRedirect = function() {
  ...
  var basename = useBasename();
  var createPath = useCreatePath();
  return (0, import_react139.useCallback)(function(redirectTo, resource, id, data, state) {
    var _a11;
    if (resource === void 0) {
      resource = "";
    }
    ...
    if (!redirectTo) {
      ...
      var absoluteTarget = typeof target === "string" ? "".concat(basename).concat(target.startsWith("/") ? "" : "/").concat(target) : __assign58({ pathname: "".concat(basename).concat(((_a11 = target.pathname) === null || _a11 === void 0 ? void 0 : _a11.startsWith("/")) ? "" : "/").concat(target.pathname) }, target);
      navigate(absoluteTarget, {
        state: __assign58({ _scrollToTop: true }, state)
      });
      return;
      ...
      navigate(createPath({ resource, id, type: redirectTo }), {
        state: (
          ...
          redirectTo === "list" ? state : __assign58({ _scrollToTop: true }, state)
        )
      });
      return;
    }
...
var useResetErrorBoundaryOnLocationChange = function(resetErrorBoundary) {
  ...
  var originalPathname = (0, import_react140.useRef)(pathname);
...
var PreferencesEditorContext = (0, import_react142.createContext)(void 0);

// node_modules/ra-core/dist/esm/preferences/PreferencesEditorContextProvider.js
var PreferencesEditorContextProvider = function(_a11) {
  var children = _a11.children;
  var _b = (0, import_react143.useState)(false), isEnabled = _b[0], setIsEnabled = _b[1];
  var _c = (0, import_react143.useState)(null), editor = _c[0], setEditor = _c[1];
  var _d = (0, import_react143.useState)(null), preferenceKey = _d[0], setPreferenceKey = _d[1];
  var _e = (0, import_react143.useState)(null), path = _e[0], setPath = _e[1];
  var _f = (0, import_react143.useState)(null), title = _f[0], setTitleString = _f[1];
  var _g = (0, import_react143.useState)(), titleOptions = _g[0], setTitleOptions = _g[1];
  var enable = (0, import_react143.useCallback)(function() {
    return setIsEnabled(true);
  }, []);
  var disable = (0, import_react143.useCallback)(function() {
    setIsEnabled(false);
    setEditor(null);
  }, []);
  var setTitle = (0, import_react143.useCallback)(function(title2, titleOptions2) {
    setTitleString(title2);
    setTitleOptions(titleOptions2);
  }, []);
  var context = (0, import_react143.useMemo)(function() {
    return {
      editor,
      setEditor,
      preferenceKey,
...
var CoreAdminContext = function(props) {
  ...
  var finalQueryClient = (0, import_react144.useMemo)(function() {
    return queryClient || new QueryClient();
  }, [queryClient]);
  var finalAuthProvider = (0, import_react144.useMemo)(function() {
    return authProvider instanceof Function ? convertLegacyAuthProvider_default(authProvider) : authProvider;
  }, [authProvider]);
  var finalDataProvider = (0, import_react144.useMemo)(function() {
...
var ErrorBoundaryContext = (0, import_react145.createContext)(null);
var initialState = {
  didCatch: false,
  error: null
};
var ErrorBoundary = class extends import_react145.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (didCatch) {
      ...
      if (typeof fallbackRender === "function") {
        ...
        childToRender = (0, import_react145.createElement)(FallbackComponent, props);
    ...
    return (0, import_react145.createElement)(ErrorBoundaryContext.Provider, {
      value: {
        didCatch,
        error,
        resetErrorBoundary: this.resetErrorBoundary
...
var useRoutesAndResourcesFromChildren = function(children, permissions, isLoading) {
  ...
  var _b = (0, import_react146.useState)(function() {
    return getStatus(__assign60({ children }, routesAndResources));
  ...
  (0, import_react146.useEffect)(function() {
    var resolveChildFunction = function(childFunc) {
      return __awaiter25(void 0, void 0, void 0, function() {
        ...
        return __generator25(this, function(_a12) {
          try {
...
var useRoutesAndResourcesState = function(initialState2) {
  var _a11 = (0, import_react146.useState)(initialState2), routesAndResources = _a11[0], setRoutesAndResources = _a11[1];
  var mergeRoutesAndResources = (0, import_react146.useCallback)(function(newRoutesAndResources) {
...
var getRoutesAndResourceFromNodes = function(children) {
  ...
  import_react146.Children.forEach(children, function(element) {
    if (!React53.isValidElement(element)) {
      return;
    }
    if (element.type === import_react146.Fragment) {
...
var HasDashboardContext = (0, import_react147.createContext)(false);
var HasDashboardContextProvider = HasDashboardContext.Provider;
var useHasDashboard = function() {
  return (0, import_react147.useContext)(HasDashboardContext);
};
    ...
    React55.createElement(Route, { path: "/*", element: React55.createElement(
      ...
      React55.createElement(
        ...
        React55.createElement(
          ...
          null,
          customRoutesWithLayout,
          import_react148.Children.map(resources, function(resource) {
...
var DefaultTitleContext = (0, import_react149.createContext)("React Admin");
var DefaultTitleContextProvider = DefaultTitleContext.Provider;
var useDefaultTitle = function() {
  return (0, import_react149.useContext)(DefaultTitleContext);
};
...
var CoreAdminUI = function(props) {
  var _a11 = (0, import_react150.useState)({}), errorInfo = _a11[0], setErrorInfo = _a11[1];
...
var createOrGetElement = function(el) {
  return (0, import_react150.isValidElement)(el) ? el : (0, import_react150.createElement)(el);
};
var Noop2 = function() {
  return null;
};
...
var getElement = function(ElementOrComponent) {
  if ((0, import_react151.isValidElement)(ElementOrComponent)) {
...
var SourceContext = (0, import_react152.createContext)(void 0);
...
var useSourceContext = function() {
  var context = (0, import_react152.useContext)(SourceContext);
  if (!context) {
...
var useOptionalSourceContext = function() {
  return (0, import_react152.useContext)(SourceContext);
};
...
var useResourceDefinition = function(props) {
  ...
  var definition = (0, import_react153.useMemo)(function() {
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react154.useCallback)(function(record) {
    if (!record)
      return "";
...
var useTranslateLabel = function() {
  ...
  return (0, import_react155.useCallback)(function(_a11) {
...
var FieldTitle_default = (0, import_react156.memo)(FieldTitle);
...
var Button = function(_a11) {
  ...
  var _b = (0, import_react157.useState)(false), hovered = _b[0], setHovered = _b[1];
  return React63.createElement(
    "div",
    null,
    React63.createElement(
      "a",
      { href, style: hovered ? __assign61(__assign61({}, styles.link), styles.linkHovered) : styles.link, onMouseEnter: function() {
...
function useWhyDidYouUpdate(name, props) {
  var previousProps = (0, import_react158.useRef)();
  (0, import_react158.useEffect)(function() {
    if (previousProps.current) {
      var allKeys = Object.keys(__assign62(__assign62({}, previousProps.current), props));
      var changesObj_1 = {};
...
var useEvent = function(fn) {
  ...
  return (0, import_react159.useCallback)(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
var useDebouncedEvent = function(callback, delay) {
  var debouncedCallbackRef = (0, import_react160.useRef)(function() {
    throw new Error("Cannot call an event handler while rendering.");
  });
  ...
  return (0, import_react160.useCallback)(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
var useCheckForApplicationUpdate = function(options) {
  ...
  var currentHash = (0, import_react161.useRef)();
...
var getHashForUrl = function(url, fetchOptions) {
  return __awaiter26(void 0, void 0, void 0, function() {
    var response, text, e_1;
    return __generator26(this, function(_a11) {
      switch (_a11.label) {
        case 0:
...
var useStore = function(key, defaultValue) {
  ...
  var _b = (0, import_react162.useState)(function() {
...
var I18nContextProvider = function(_a11) {
  ...
  var notify = useNotify();
  var _c = (0, import_react163.useState)(0), key = _c[0], setKey = _c[1];
  var _d = (0, import_react163.useState)(locale === value.getLocale()), isInitialized = _d[0], setInitialized = _d[1];
...
var PreferenceKeyContext = (0, import_react164.createContext)("");
...
var usePreferenceKey = function() {
  return (0, import_react164.useContext)(PreferenceKeyContext);
};
...
var usePreferencesEditor = function() {
  var context = (0, import_react165.useContext)(PreferencesEditorContext);
  if (!context) {
...
var usePreferenceInput = function(key, defaultValue) {
  ...
  var _b = (0, import_react166.useState)(valueFromStore), value = _b[0], setValue = _b[1];
...
var InferredElement = (
  ...
  function() {
    ...
    InferredElement2.prototype.getElement = function(props) {
      ...
      return this.children ? (0, import_react168.createElement)(this.type.component, __assign63(__assign63({}, this.props), props), this.children.length > 0 ? this.children.map(function(child, index) {
        return child.getElement({ key: index });
      }) : this.children.getElement()) : (0, import_react168.createElement)(this.type.component, __assign63(__assign63({}, this.props), props));
    };
...
function startOfWeek(date, options) {
  ...
  const weekStartsOn = (options == null ? void 0 : options.weekStartsOn) ?? ((_b = (_a11 = options == null ? void 0 : options.locale) == null ? void 0 : _a11.options) == null ? void 0 : _b.weekStartsOn) ?? defaultOptions2.weekStartsOn ?? ((_d = (_c = defaultOptions2.locale) == null ? void 0 : _c.options) == null ? void 0 : _d.weekStartsOn) ?? 0;
  const _date = toDate(date);
...
function getWeekYear(date, options) {
  ...
  const year = _date.getFullYear();
  const defaultOptions2 = getDefaultOptions();
  const firstWeekContainsDate = (options == null ? void 0 : options.firstWeekContainsDate) ?? ((_b = (_a11 = options == null ? void 0 : options.locale) == null ? void 0 : _a11.options) == null ? void 0 : _b.firstWeekContainsDate) ?? defaultOptions2.firstWeekContainsDate ?? ((_d = (_c = defaultOptions2.locale) == null ? void 0 : _c.options) == null ? void 0 : _d.firstWeekContainsDate) ?? 1;
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4ZDPLDVL.js.map
