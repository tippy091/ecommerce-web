...
var TextArrayInput = function (_a) {
    ...
    var _b = (0, ra_core_1.useInput)(__assign({ disabled: disabled, format: format, parse: parse, readOnly: readOnly, source: source, validate: validate }, props)), field = _b.field, _c = _b.fieldState, error = _c.error, invalid = _c.invalid, id = _b.id, isRequired = _b.isRequired;
    ...
    return (React.createElement(StyledAutocomplete, __assign({ multiple: true, freeSolo: true, autoSelect: true, options: [], id: id, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), renderTags: function (value, getTagProps) {
        ...
        }, renderInput: function (params) { return (React.createElement(material_1.TextField, __assign({}, params, { label: label !== '' && label !== false ? (React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: props.resource, isRequired: isRequired })) : null, helperText: renderHelperText ? (React.createElement(InputHelperText_1.InputHelperText, { error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText })) : null, error: invalid, variant: variant, margin: margin, size: size }))); }, sx: sx }, field, { value: field.value || emptyArray, onChange: function (e, newValue) { return field.onChange(newValue); } }, props, { disabled: disabled || readOnly })));
};
