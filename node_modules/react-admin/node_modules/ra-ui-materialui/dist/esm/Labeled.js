...
export var Labeled = function (_a) {
    ...
    , __assign({ 
        ...
        label !== false &&
            ...
            // @ts-ignore
            ((_d = children.type) === null || _d === void 0 ? void 0 : _d.displayName) !== 'Labeled' ? (React.createElement(Typography, __assign({ sx: color
                ? undefined
                : {
                    color: function (theme) { return theme.palette.text.secondary; },
                }, color: color, className: LabeledClasses.label }, TypographyProps),
